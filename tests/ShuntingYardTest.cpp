...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        InfixToPrefix{"1", "1.0"}, InfixToPrefix{"-1", "1.0 -"},
        InfixToPrefix{"(-1)*4", "1.0 - 4.0 *"},
        InfixToPrefix{"55342+0.6", "55342.0 0.6 +"},
        ...
        InfixToPrefix{"(2.1^2+5.2-7.2)*7.1", "2.1 2.0 ^ 5.2 + 7.2 - 7.1 *"},
